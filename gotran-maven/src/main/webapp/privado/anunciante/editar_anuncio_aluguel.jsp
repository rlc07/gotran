...
<title>Editar Anúncio - Aluguel de Veiculo</title>
			    ...
			    <div class="inner-content">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
								...
								<!-- Inicio formulario -->
								<form action="" id="fmAtAnAl" method="post">
								<!-- Inicio linha -->
								<div class="row">
									...
									<!-- IMAGEM DO VEICULO -->
								     <div class="col-sm-12 col-md-4" style="margin-top: 10px;">
                                        ...
                                        <label>Marca</label>
									    <input type="text" name="marca" id="marca" disabled="disabled" value="${anAluguel.veiculo.marca}">
									    </div>
									    
                                         <div class="form-group" >
                                        <label>Modelo</label>
									    <input type="text" name="modelo" id="modelo" disabled="disabled" value="${anAluguel.veiculo.modelo}">
									    </div>
									    </div>
								...
								<div class="form-group">
								<label>Titulo*</label>
								<input type="text" class="form-control" value="${anAluguel.nome_empresa}"
								...
								<div class="form-group">
								<label>Valor</label>
								<input type="text" class="form-control" value="${anAluguel.valor}" id="valor">
								</div>
								
								 <div class="form-group">
															<label>Desativado\Ativado</label></br>
												<label class="on-off">
												<input type="checkbox" name="status" <c:if test="${anAluguel.status == true}">checked="checked"</c:if> /> 
												<span><a></a></span>
												</label>
														</div>
								<!-- Fim coluna 2 -->
							...
							<input type="hidden" value="${anAluguel.id_anuncio}" name="id_anuncio">
								<!-- Fim coluna 2 -->
								</div>
								<!-- Fim linha 3 -->

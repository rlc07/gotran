                    ...
                    <div class="panel theme-panel">
                        <div class="panel-body">
								...
								<!-- IMAGEM DO VEICULO -->
								     <div class="col-sm-12 col-md-4">
										...
										<select class="form-control " id="veiculo"  name="veiculo">
										 ...
										 <div class="form-group">
										 <label>Titulo*</label>
										 <input type="text" placeholder="Ex.:(Joao Transportes Escolares)"
							...
							<hr>
								...
								<div class="form-group">
									<div class="col-sm-10">
										<label class="control-label" >Descrição Anuncio</label>
										<textarea name="descricao_escolar" rows="" cols="" class="form-control" 

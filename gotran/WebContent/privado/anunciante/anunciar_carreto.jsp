...
<title>Anunciar - Frete\Carreto</title>
			    ...
			    <div class="inner-content">
                    <div class="panel theme-panel">
                        ...
                        <!-- INICIO PAINEL -->
								...
								<!-- INICIO FORMULARIO -->
								<form action="" method="POST" id="fmCadAnFr">
								...
								<div class="col-sm-12 col-md-4" style="margin-top: 30px;">
								 ...
								 <div class="form-group">
								 <label>Titulo</label>
								 <input type="text" class="form-control" placeholder="Ex.: (Gotran frete e carreto)" 
								 ...
								 <div class="radio" >
										<label><input type="radio" name="tipo" value="kilo" onclick="alterna(this.value);">Kilo</label>
										<label><input type="radio" name="tipo" value="tonelada" onclick="alterna(this.value);">Tonelada</label>
									</div>
								...
								<div class="col-sm-12 col-md-4" style="margin-top: 104px;">
								...
								<div class="form-group col-md-10">
								 ...
								 <input type="text" class="form-control"  name="valor" id="valor">
											...
											<div class="form-group">
												...
												<div class="radio" >
													<label><input type="radio" name="disp_vg_frete" value="Sim">Sim</label>
													<label><input type="radio" name="disp_vg_frete" value="Nao">Não</label>

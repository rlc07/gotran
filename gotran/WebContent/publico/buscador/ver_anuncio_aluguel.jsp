    ...
    <!-- Inicio linha 1 -->
                          ...
                          <div class="col-md-4 col-sm-10">
                                   ...
                                   <div class="panel panel-default">
										...
										<div align="center">
										<h3><b style="">${anAluguel.nome_empresa}</b></h3>
										</div>
										</div>
									</div>
                          ...
                          <div class="Panel with panel-success class">
										...
										<!-- Col 1 -->
										<div align="right">
										 <p><b>Publicado em:</b> ${anAluguel.data_cadastro}</p>
										</div>
										<!-- Fim COl 1 -->
										...
										<p><b>Endereço: </b><c:if test="${anAluguel.rua != null || anAluguel.rua != ''}">
										${anAluguel.rua}, </c:if> <c:if test="${anAluguel.numero == 0 }">S\N </c:if> 
										<c:if test="${anAluguel.numero != 0 }"> ${anAluguel.numero} </c:if> 
										${anAluguel.cidade }</p>
										...
										<p><b>Valor: </b> <c:if test="${anAluguel.valor == '0.0'}">A COMBINAR</c:if>
										<c:if test="${anAluguel.valor != '0.0'}">A partir de R$ ${anAluguel.valor}</c:if></p>

...
<title>Buscar Transporte - Excursão</title>
...
<body  style="background-color: #C7C7C7;">
    ...
    <jsp:include page="/template/cabecalho_buscador.jsp"></jsp:include>
     <jsp:include page="/template/barra_transporte.jsp"></jsp:include>
       ...
       <div class="col-md-12">
        <form method="POST" action="${pageContext.request.contextPath}/buscar?action=buscar-anuncio-excursao">
         ...
         <div class="form-group col-md-4">
          ...
          <div class="form-group col-md-4">
                   <label><span class="fa fa-globe "></span> Destino</label>
                              <input type="text" class="form-control" name="destino" value="${destino}">
                              ...
                              <button type="submit" class="btn btn-primary" id="btnFiltro">
                             	<span class="fa fa-search"></span> Buscar</button>
         									...
         									<input type="hidden" value="${cid}" name="cidade_excursao">
       ...
       <hr><hr>
             ...
             <div class="row">
              <div class="col-md-12">
                              ...
                              <table class="row-border hover" id="tbBuscarExcursao">
                                  <thead>
                                     <tr>
                                        <td></td>
                                        <td></td>
                                  ...
                                  <tbody>
                                     <c:forEach items="${lsExcursao}" var="anExcursao">
                                          <tr>
                                           ...
                                           <td>
                                           <a href="${pageContext.request.contextPath}/buscar?action=vizualizar-anuncio-excursao&id_anuncio=${anExcursao.id_anuncio}" ><b style="font-size: 17px;">${anExcursao.nome_empresa}</b></a>
                                           
                                           <div style="margin-top: 30px;">
                                             Destino: ${anExcursao.destino}
                                           ...
                                           <b style="color:green;"><c:if test="${anExcursao.valor != '0.0'}">R$ ${anExcursao.valor}</c:if></b>
                                           
                                           <div style="margin-top: 20px;">
                                           Publicado em: ${anExcursao.data_cadastro}
                                           </div>
                                           </td>
...
$(document).ready(function(){
	 $('#tbBuscarExcursao').DataTable({
	    "language": {
        "lengthMenu": " _MENU_ Anúncio por pagina",
        "zeroRecords": "<h3>Ops, não existe nenhum anúncio de excursão disponivel no momento!<h3>",

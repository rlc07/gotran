		    ...
		    $("#formLogin").validate({
		     ...
		     email_login: {
		         ...
		         messages:{
		              senha_login:{
		                        required: "Campo obrigatorio!",
		           		    	 rangelength: "A senha deve conter entre 4 á 10 caracteres."
		     ...
		     success :  function(response)
		      ...
		      $("#erro-login").html('<div class="alert alert-danger">email ou senha invalido <span class="fa fa-times"></span>&nbsp; '+response+' !</div>');
           			...
           			if(response.length > 0){
           				for(var i = 0; i < response.length; i++)
           				{
           					if(response[i].id_veiculo == id){
                                   ...
                                   document.getElementById('img_veiculo').src = "http://localhost:8080/gotran/img_gotran/img_veiculo/"+response[i].img_veiculo;
